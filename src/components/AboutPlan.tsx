    ...
    return (
        <section id="about" className="py-20 lg:py-32 bg-white overflow-hidden relative">
            ...
            <img
                ...
                alt=""
                className="absolute top-16 right-8 w-48 opacity-[0.09] pointer-events-none"
            />
            <img
                src="/assets/images/star-accent.png"
                alt=""
                className="absolute bottom-24 left-5 w-36 opacity-[0.07] pointer-events-none rotate-12"
            />
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="relative">
                        ...
                        <img
                            ...
                            alt="Medical Team"
                            className="rounded-[2rem] shadow-2xl relative z-10 w-full object-cover h-[500px] lg:h-[650px]"
                        />
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-primary-light/10 rounded-full blur-3xl -z-10" />
                    ...
                    <div className="lg:pl-8">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-light/20 text-accent-dark font-medium text-sm mb-6 border border-accent-light/30">
                            {t('about.badge')}
                        </div>

                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary-dark mb-6 leading-[1.2]">
                            {t('about.title1')} <br />
                            ...
                            {items.map((item, idx) => (
                                <li key={idx} className="flex gap-4 group">
                                    <div className="flex-shrink-0 mt-1">
                                        <div className="w-12 h-12 rounded-2xl bg-gray-50 flex items-center justify-center group-hover:bg-primary-base group-hover:text-white transition-colors duration-300">
                                            <CheckCircle2 size={24} className="text-primary-base group-hover:text-white transition-colors duration-300" />
                                        </div>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-gray-900 text-xl tracking-tight mb-1">{item.title}</h3>
